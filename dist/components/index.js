...
var canvas_inline_default = 'function G(){let y=document.querySelectorAll(".canvas-container");if(y.length!==0)for(let t of Array.from(y)){if(t.dataset.initialized==="true")continue;t.dataset.initialized="true";let w=t.querySelector(".canvas-viewport");if(!w)continue;let K=t.dataset.enableInteraction!=="false",Y=parseFloat(t.dataset.minZoom??"")||.1,H=parseFloat(t.dataset.maxZoom??"")||5,o=parseFloat(t.dataset.initialZoom??"")||1,c=0,l=0,X=!1,I=0,z=0,g=()=>{w.style.transform=`translate(${c}px, ${l}px) scale(${o})`},x=()=>{let n=t.getBoundingClientRect(),a=parseFloat(w.style.width)||1e3,u=parseFloat(w.style.height)||1e3,r=n.width/a,d=n.height/u;o=Math.min(r,d,1)*.9,o=Math.max(Y,Math.min(H,o)),c=(n.width-a*o)/2,l=(n.height-u*o)/2,g()};x();let b=o,B=c,q=l,T=t.querySelector(".canvas-reset-view"),v=()=>{if(!T)return;let n=Math.abs(o-b)>.001||Math.abs(c-B)>1||Math.abs(l-q)>1;T.style.display=n?"flex":"none"},h=[];if(K){let n=e=>{let s=e.target instanceof HTMLElement?e.target.closest(".canvas-node-content"):null;if(s&&s.scrollHeight>s.clientHeight){let p=s.scrollTop<=0,m=s.scrollTop+s.clientHeight>=s.scrollHeight-1,f=e.deltaY>0,L=e.deltaY<0;if(!(p&&L)&&!(m&&f))return}if(e.preventDefault(),e.ctrlKey){let i=t.getBoundingClientRect(),p=e.clientX-i.left,m=e.clientY-i.top,f=o,L=e.deltaY>0?.9:1.1;o=Math.max(Y,Math.min(H,o*L)),c=p-(p-c)*(o/f),l=m-(m-l)*(o/f)}else c-=e.deltaX,l-=e.deltaY;g(),v()},a=e=>{e.button===0&&(e.target instanceof HTMLElement&&(e.target.closest("a")||e.target.closest("button"))||e.target instanceof HTMLElement&&e.target.closest(".canvas-node-content")||(X=!0,I=e.clientX-c,z=e.clientY-l,t.setPointerCapture(e.pointerId)))},u=e=>{X&&(c=e.clientX-I,l=e.clientY-z,g(),v())},r=()=>{X=!1};t.addEventListener("wheel",n,{passive:!1}),t.addEventListener("pointerdown",a),t.addEventListener("pointermove",u),t.addEventListener("pointerup",r);let d=0,E=0,R=0,Z=!1,A=e=>{if(e.length<2||!e[0]||!e[1])return 0;let s=e[0].clientX-e[1].clientX,i=e[0].clientY-e[1].clientY;return Math.sqrt(s*s+i*i)},D=e=>{if(e.touches.length===2){let s=e.touches[0],i=e.touches[1];if(!s||!i)return;e.preventDefault(),Z=!0,X=!1,d=A(e.touches),E=(s.clientX+i.clientX)/2,R=(s.clientY+i.clientY)/2}},O=e=>{if(e.touches.length===2&&Z){let s=e.touches[0],i=e.touches[1];if(!s||!i)return;e.preventDefault();let p=A(e.touches),m=(s.clientX+i.clientX)/2,f=(s.clientY+i.clientY)/2,L=t.getBoundingClientRect(),N=m-L.left,U=f-L.top,j=p/d,W=o;o=Math.max(Y,Math.min(H,o*j)),c=N-(N-c)*(o/W),l=U-(U-l)*(o/W),c+=m-E,l+=f-R,d=p,E=m,R=f,g(),v()}},$=e=>{e.touches.length<2&&(Z=!1)};t.addEventListener("touchstart",D,{passive:!1}),t.addEventListener("touchmove",O,{passive:!1}),t.addEventListener("touchend",$),h.push(()=>{t.removeEventListener("wheel",n),t.removeEventListener("pointerdown",a),t.removeEventListener("pointermove",u),t.removeEventListener("pointerup",r),t.removeEventListener("touchstart",D),t.removeEventListener("touchmove",O),t.removeEventListener("touchend",$)})}let F=t.closest(\'.page[data-frame="canvas"]\'),S=F?.querySelector(".canvas-sidebar-toggle");if(F&&S){let n=()=>{let a=t.getBoundingClientRect();F.classList.toggle("canvas-sidebar-open"),requestAnimationFrame(()=>{let r=t.getBoundingClientRect().left-a.left;c+=r,B+=r,g(),v()})};S.addEventListener("click",n),h.push(()=>{S.removeEventListener("click",n)})}let C=t.querySelector(".canvas-zoom-in"),k=t.querySelector(".canvas-zoom-out"),P=n=>{let a=t.getBoundingClientRect(),u=a.width/2,r=a.height/2,d=o;o=Math.max(Y,Math.min(H,o*n)),c=u-(u-c)*(o/d),l=r-(r-l)*(o/d),g(),v()};if(C){let n=()=>{P(1.25)};C.addEventListener("click",n),h.push(()=>C.removeEventListener("click",n))}if(k){let n=()=>{P(.8)};k.addEventListener("click",n),h.push(()=>k.removeEventListener("click",n))}if(T){let n=()=>{x(),b=o,B=c,q=l,v()};T.addEventListener("click",n),h.push(()=>T.removeEventListener("click",n))}let M=t.querySelector(".canvas-fullscreen-toggle");if(M){let n=M.querySelector(".canvas-fullscreen-enter"),a=M.querySelector(".canvas-fullscreen-exit"),u=()=>{let E=document.fullscreenElement===t;n&&(n.style.display=E?"none":""),a&&(a.style.display=E?"":"none")},r=()=>{document.fullscreenElement===t?document.exitFullscreen():t.requestFullscreen()},d=()=>{u(),requestAnimationFrame(()=>{x(),b=o,B=c,q=l,v()})};M.addEventListener("click",r),document.addEventListener("fullscreenchange",d),h.push(()=>{M.removeEventListener("click",r),document.removeEventListener("fullscreenchange",d)})}let V=t.querySelectorAll(".canvas-iframe-wrapper iframe");for(let n of Array.from(V))n.addEventListener("error",()=>{let a=n.parentElement?.querySelector(".canvas-iframe-fallback");a&&(n.style.display="none",a.style.display="flex")});typeof window<"u"&&window.addCleanup&&window.addCleanup(()=>{for(let n of h)n();t.dataset.initialized="false"})}}if(typeof document<"u"){let y=()=>{G()};document.addEventListener("nav",y),document.addEventListener("render",y)}\n';
var l;
